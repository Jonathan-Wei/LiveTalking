...
from ttsreal import EdgeTTS,VoitsTTS,XTTS,CosyVoiceTTS,FishTTS,TencentTTS,KokoroTTS
...
class BaseReal:
    def __init__(self, opt):
        ...
        logger.info(f"----tts model is : {opt.tts}")
        ...
        elif self.opt.tts == "kokoro-tts":
            self.tts = KokoroTTS(opt,self)
